...
export 'package:flutter_web_data_table/src/web_data_column.dart';
export 'package:flutter_web_data_table/src/web_data_table_source.dart';
    ...
    for (Map<String, dynamic> row in rows) {
      ...
      for (final filterText in filterTexts!) {
        for (final valueText in valueTexts) {
          if (valueText.toLowerCase().contains(filterText)) {
            containCount++;
            break;
          }
        }
