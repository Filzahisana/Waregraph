...
import 'package:waregraph/view/pages/pipa_besar/pb_detailitem.dart';
// import 'package:waregraph/view/pages/dashboard/dashboard.dart';

class PipaBesar extends StatefulWidget {
  const PipaBesar({super.key});

  @override
  State<PipaBesar> createState() => _PipaBesarState();
}

class _PipaBesarState extends State<PipaBesar> {
  Widget detailItem = PB_DetailItem();
